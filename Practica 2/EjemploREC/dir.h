...
#define READDIR 1
extern  reddir_res * readdir_1(nametype , CLIENT *);
extern  reddir_res * readdir_1_svc(nametype , struct svc_req *);
extern int dirprog_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define READDIR 1
extern  reddir_res * readdir_1();
extern  reddir_res * readdir_1_svc();
