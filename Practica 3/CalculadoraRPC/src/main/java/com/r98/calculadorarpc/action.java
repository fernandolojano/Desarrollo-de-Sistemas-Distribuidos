...
public class action implements org.apache.thrift.TBase<action, action._Fields>, java.io.Serializable, Cloneable, Comparable<action> {
  ...
  public action setOperator1(double operator1) {
    this.operator1 = operator1;
    setOperator1IsSet(true);
    return this;
  }
  ...
  public action setOperator2(double operator2) {
    this.operator2 = operator2;
    setOperator2IsSet(true);
    return this;
  }
  ...
  public action setOperator3(double operator3) {
    this.operator3 = operator3;
    setOperator3IsSet(true);
    return this;
  }
  ...
  public action setOperator4(double operator4) {
    this.operator4 = operator4;
    setOperator4IsSet(true);
    return this;
  }
   ...
   * @see Operator
   */
  public action setOp(@org.apache.thrift.annotation.Nullable Operator op) {
    this.op = op;
    return this;
  }
